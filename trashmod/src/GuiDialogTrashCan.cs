...
namespace trashmod
{
    public class GuiDialogTrashCan : GuiDialogBlockEntity
    {
        ...
        private bool OnEmptyTrashClick()
        {
            ...
            capi.Logger.Event("[TrashMod] Empty button has been clicked by client. Sending packet to {0}.", capi.World.BlockAccessor.GetBlockEntity(BlockEntityPosition).Block.Code);
